  ...
  return (
    <section id="hero" style={{ position:"relative", minHeight:"100vh", background:"#07060a", display:"flex", alignItems:"center", overflow:"hidden" }}>
      <style>{`
        ...
        @media(max-width:768px) { .gn-hero-grid { grid-template-columns:1fr!important; padding:5rem 1.25rem 3rem!important; gap:2.5rem!important; } }
        @media(max-width:768px) { .gn-two-col { display:block!important; } .gn-two-col>*{margin-bottom:2rem;} }
      `}</style>
      ...
      {/* ── Content ── */}
      <div className="gn-hero-grid" style={{
        ...
        <div>
          ...
          <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.6, delay:0.8 }}
            ...
            {(data?.resumeBase64 || data?.resumeUrl || data?.resume_url) && (
              <a href={data.resumeBase64 ? `data:application/pdf;base64,${data.resumeBase64}` : (data.resumeUrl || data.resume_url)} download="Resume.pdf" className="gn-cta-secondary">
        ...
        {hasPhoto && (
          ...
          >
            ...
            <div style={{ position:"relative", width:"340px", height:"380px" }}>
              ...
              {/* Photo */}
              <img src={data.heroImageBase64 || data.profile_photo} alt={data.name} style={{
